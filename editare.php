...
<html lang="ro">
    ...
    <body>
        ...
        <form action="editare.php" method="GET" name="form" id="form">
            ...
            function sorting($type){
                ...
                while($row= mysqli_fetch_array($r)){
                    ...
                    $art[]= "<figure id='figures'>"."<!--[if IE]><span id='figure'><![endif]-->"
                                ...
                                ."<form action=panouedit.php method=POST class=delform>"
                                    ."<input type=hidden name={$row['id']} value='artDelete'>"
                                    ."<input type=submit value=Editare class=delsub>"
                                ."</form>"
                                ."<!--[if IE]></div><![endif]-->"
                ...
                if(!empty($art)){
                    ...
                    echo '<h3 style="text-indent:2em;">Căutarea nu a generat nici un rezultat.<h3>';}
            }
            if(!empty($_GET)){
        ...
        <form action='editare.php' method="GET" id="paging">
