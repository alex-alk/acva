...
<html lang="ro">
    ...
    <body>
        ...
        <h2>Selectati articolul pentru care vreți să creați oferta</h2>
        <form action="oferteadauga.php" method="GET" name="form" id="form">
        ...
        $dbc = dbc();
            ...
            function sorting($type){
                    ...
                    while($row= mysqli_fetch_array($r)){
                        ...
                        $art[]= "<a href='ofertaselect.php?name={$row['image']}'><figure id='figure'>"."<!--[if IE]><span id='figure'><![endif]-->"
                            ...
                            ."<p>Preț: <span> $pricespecial</span> lei</p>"."<!--[if IE]></div><![endif]-->"
            ...
            if(empty($_GET)){
                ...
                while($row= mysqli_fetch_array($r)){
                    if($firstIndex<=$curPage*15){
                        $namespecial= htmlspecialchars($row['name']);
                        $pricespecial= htmlspecialchars($row['price']);
                    echo "<a href='ofertaselect.php?name={$row['image']}'><figure id='figure'>"."<!--[if IE]><span id='figure'><![endif]-->"
                        ."<img id=img src='images/{$row['image']}.jpg' width='100' alt='img'>"
                        ."<figcaption id='figcaption'>"."<!--[if IE]><div id='figcaption'><![endif]-->"
                        ."<p class='name'>$namespecial</p>"
                        ."<p>Preț: <span> $pricespecial</span> lei</p>"."<!--[if IE]></div><![endif]-->"
        ...
        <form action='oferteadauga.php' method="GET" id="paging">
